...
`Â col5:Â `[`GO:0006915`](GO:0006915)
`Â col16:Â part_of(ZFS:0000023)`
...
`Â col5:Â `[`GO:0003924`](GO:0003924)`Â Â Â Â Â Â GTPaseÂ activity`
`Â col16:Â part_of(GO:0048011Â neurotrophinÂ TRKÂ receptorÂ signalingÂ pathway)`
...
`Â col5:Â `[`GO:0016301`](GO:0016301)
`Â col16:Â part_of(GO:0016310)`
...
`Â col5:Â GOÂ FunctionÂ ID`
`Â col16:Â part_of(GOÂ PROCESSÂ ID),occurs_in(GOÂ CCÂ ID)`
