...
`ÃÂÃÂÃÂÃÂ col5:ÃÂÃÂÃÂÃÂ `[`GO:0006915`](GO:0006915)
`ÃÂÃÂÃÂÃÂ col16:ÃÂÃÂÃÂÃÂ part_of(ZFS:0000023)`
...
`ÃÂÃÂÃÂÃÂ col5:ÃÂÃÂÃÂÃÂ `[`GO:0003924`](GO:0003924)`ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ GTPaseÃÂÃÂÃÂÃÂ activity`
`ÃÂÃÂÃÂÃÂ col16:ÃÂÃÂÃÂÃÂ part_of(GO:0048011ÃÂÃÂÃÂÃÂ neurotrophinÃÂÃÂÃÂÃÂ TRKÃÂÃÂÃÂÃÂ receptorÃÂÃÂÃÂÃÂ signalingÃÂÃÂÃÂÃÂ pathway)`
...
`ÃÂÃÂÃÂÃÂ col5:ÃÂÃÂÃÂÃÂ `[`GO:0016301`](GO:0016301)
`ÃÂÃÂÃÂÃÂ col16:ÃÂÃÂÃÂÃÂ part_of(GO:0016310)`
...
`ÃÂÃÂÃÂÃÂ col5:ÃÂÃÂÃÂÃÂ GOÃÂÃÂÃÂÃÂ FunctionÃÂÃÂÃÂÃÂ ID`
`ÃÂÃÂÃÂÃÂ col16:ÃÂÃÂÃÂÃÂ part_of(GOÃÂÃÂÃÂÃÂ PROCESSÃÂÃÂÃÂÃÂ ID),occurs_in(GOÃÂÃÂÃÂÃÂ CCÃÂÃÂÃÂÃÂ ID)`
